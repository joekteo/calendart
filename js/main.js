...
(function() {
  $(function() {
    var aboutTemplate, contactTemplate, eventsTemplate, helpTemplate, jobsTemplate, main, newsTemplate, privacyTemplate, reviewsTemplate, setActive, termsTemplate, unsetActive;
    ...
    return $('#footer-navlinks').on('click', '#privacy-link', function(e) {
      e.preventDefault();
